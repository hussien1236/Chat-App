...
const PreviewAttachmentModal = ({attachments, index, show=false, onClose = ()=>{}}) => {
              ...
              <Transition.Child
                ...
                leaveTo='opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95'>
                 <Dialog.Panel className="flex flex-col w-full h-full transform
                  ...
                  <button 
                  onClick={close}
                  className='absolute right-3 top-3 w-10 h-10 rounded-full bg-gray-700 hover:bg-black/30 transition flex items-center
                  ...
                  <div className='relative group h-full'>
                    ...
                    {currentIndex < (previewableAttachments.length-1) && (
                      ...
                      onClick={next}
                      className='absolute opacity-100 text-gray-100
                      cursor-pointer flex items-center justify-center w-16 h-16 right-4 top-1/2 -translate-y-1/2
                      rounded-full bg-black/50 z-30'>
