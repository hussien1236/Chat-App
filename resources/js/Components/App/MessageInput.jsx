...
const MessageInput = ({conversation = null, messagesCtrRef}) => {
    ...
    <div className='flex flex-wrap items-start border-t border-slate-700 py-3'>
        ...
        xs-order-2 flex-1 relative'>
          <div className='flex'>
            ...
            />
            <button onClick={onSendClick} disabled={messageSending} className='btn btn-info rounded-l-none text-white'>
              {messageSending && (
          ...
          <div className='flex flex-wrap gap-1 mt-2'>
             {chosenFiles.map((file)=>{
              ...
              className={`relative flex justify-between cursor-pointer ${isImage(file.file) ? 'w-fit' : ''}`}>
               {isImage(file.file) && (
               <img src={file.url}
